...
df = pd.read_csv("mushroom_EM.csv")
...
plt.ylabel('Accuracy')
plt.title('Accuracy vs Number of Hidden Layers for Mushrooms')
plt.legend(loc='best')
fig.savefig('figures/Mushrooms_neural_hidden.png')
plt.close(fig)
...
plt.ylabel('Accuracy')
plt.title('Accuracy vs Number of Neurons for Mushrooms')
plt.legend(loc='best')
fig.savefig('figures/Mushrooms_neural_neuron.png')
plt.close(fig)
...
plt.legend(loc='best')
fig.savefig('figures/Mushrooms_neural_trainingSize.png')
plt.close(fig)
