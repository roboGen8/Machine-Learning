...
plt.ylabel('Accuracy')
plt.legend(loc='best')
plt.title('Accuracy vs Number of Estimators for Pulsar Stars')
fig.savefig('figures/Pulsar_stars_bosting_estimator.png')
plt.close(fig)
...
plt.legend(loc='best')
fig.savefig('figures/Pulsar_stars_bosting_trainingSize.png')
plt.close(fig)
