...
plt.ylabel('Accuracy')
plt.title('Accuracy vs Training size versus for Mushrooms')
plt.legend(loc='best')
fig.savefig('figures/Mushrooms_decision_trainingSize.png')
plt.close(fig)
...
plt.ylabel('Accuracy')
plt.title('Accuracy vs Max Depth for Mushrooms')
plt.legend(loc='best')
fig.savefig('figures/Mushrooms_decision_maxdepth.png')
plt.close(fig)
